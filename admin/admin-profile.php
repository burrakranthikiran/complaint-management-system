...
<script src="https://www.kryogenix.org/code/browser/sorttable/sorttable.js"></script>
  ...
  <div class="animated fadeIn">
    ...
    <div class="div" style="width: 85%;">
        <div class="col">
          <?php $result = mysql_query("SELECT * FROM `view_cmp`");
            $num_rows = mysql_num_rows($result);
            ?>
            
            
            <div class="row">
            <div class="col"><h1>List of Users<br><button class="btn btn-outline-success my-2 my-sm-0" id="export_button" type="submit">Export</button></h1> 
            </div>
            <div class="col"></div>
            </div>
        ...
        <table class="sortable table table-striped table-bordered" id="employee_data" >
                    <thead style="background-color:#007BFF;">
                        <tr>
                            <th scope="col" style="white-space: nowrap;"><b>User Reference Number</b></th>
                            <th scope="col" style="white-space: nowrap;"><b>Officers</b></th>
                    ...
                    <tbody id="geeks">
                        <?php while($data=mysql_fetch_array($result)) { ?>
                            <tr>
                                ...
                                <td  value="<?php echo $data['dummy'] ?>" class="uuId" style="white-space: nowrap;">
                                   <?php echo $data['dummy'] ?>
                                </td>
                                <td value="<?php echo $data['phone no'] ?>"  class="lot" style="white-space: nowrap;">
                               ...
                               <td>
         				        <a class="btn-lg btn-primary" href="mesg.php?id=<?php echo $data[id] ?>">More Details</a>
                                </td>
