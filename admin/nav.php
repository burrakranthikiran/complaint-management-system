<?php
 ...
 ?>
    <nav class="admin" style="background:#FC00D5">
      <ul>
        <h1><img src="/admin/files/img/logo.png" style="height: 50%;width: 50%;"></h1>
        ...
        <li><a class="disable" href="message.php">
          ...
          <li><a href="../logout.php" onClick="javascript:return confirm ('Do you want Logout?');">
            <svg fill="#FFFFFF" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 0h24v24H0z" fill="none"/>
